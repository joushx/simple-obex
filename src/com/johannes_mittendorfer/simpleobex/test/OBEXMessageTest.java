...
public class OBEXMessageTest {
    ...
    public void testGenerate(){
        ...
        byte[] expected = TestUtil.hexStringToByteArray("83003bcb0000000101002100740065006c00650063006f006d002f00700062002e0076006300660000420012782d62742f70686f6e65626f6f6b00");
    ...
    public void testGenerateConnect(){
        ...
        message.addHeader(new TargetHeader(TestUtil.hexStringToByteArray("796135f0f0c511d809660800200c9a66")));

        byte[] expected = TestUtil.hexStringToByteArray("80001a1000fffe460013796135f0f0c511d809660800200c9a66");
        byte[] actual = message.getBytes();
    ...
    public void testParse(){
        byte[] data = TestUtil.hexStringToByteArray("83003acb0000000101002100740065006c00650063006f006d002f00700062002e0076006300660000420012782d62742f70686f6e65626f6f6b00");
